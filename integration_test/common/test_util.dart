...
extension WidgetTesterExtension on WidgetTester {
  ...
  Future<void> pumpTillDone(
    ...
    Future.doWhile(() async {
      ...
      await Future.delayed(
        ...
        () async {
          await pump();
          afterTime = Duration(milliseconds: afterTime.inMilliseconds + delayMilliseconds);
        },
      );
  ...
  Future<void> openMainPage() async {
    ...
    await pumpTillOneVisible([mainPageFinder]);
  }
  ...
  Future<void> takeScreenShot({
    ...
    if (!kIsWeb) {
      ...
      await binding.takeScreenshot('${TestConfig.webScreenShotsFolder}/$fileName');
    }
  }
